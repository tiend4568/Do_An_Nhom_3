...
du-an-nhom-btth3/
├── src/main/
│   ├── Main.java              ← Chuong trinh chinh
│   ├── SinhVien.java          ← Lop doi tuong SinhVien
│   └── QuanLySinhVien.java    ← Lop quan ly danh sach
├── docs/
│   └── tailieu.docx           ← Tai lieu mo ta du an
└── README.md
```
...
Du an nhom - Bai thuc hanh SCM

--- Danh sach sinh vien ---
  [SV001] Nguyen Van A - Khoa: CNTT
  [SV002] Tran Thi B - Khoa: CNTT
  [SV003] Le Van C - Khoa: CNTT
